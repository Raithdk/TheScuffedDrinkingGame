...
public class StringMetadata {
    ...
    public final static String neutralPrompts = "Hvis du er den yngste i selskabet skal du drikke ud \n" +
            ...
            "Drik antallet af bogstaver i dit fornavn i tåre\n" +
    ...
    public final static String drinkPrompts =
            "Alle med briller drikker /x tåre\n" +
                    ...
                    "Hvis du har ét mellemnavn skal du drikke /x tåre, hvis du har mere, drik dobbelt \n" +
                    ...
                    "Alle lavere end dig drikker /x tåre - Er du den laveste drikke du selv dobbelt tåre\n" +
                    "Alle højere end dig drikker /x tårer - Er du den højeste drikker du selv dobbelt tåre\n" +
                    ...
                    "Du vælger om alle (dig selv inklusiv) skal drikke /x tåre eller ej\n";
    ...
    public final static String darePrompts = "Vis dit bedste move på dansegulvet eller tøm dit glas\n" +
            ...
            "Hold en tale om det fantastiske design af sodavandsdåsen\n" +
            "Hold en tale om hvorfor øl faktisk ikke er øl\n" +
            "Hold en tale om hvorfor ananas skal/ikke skal på pizza\n" +
    ...
    public final static String votePrompts = "Kat eller hund? \n" +
            ...
            "Uvejr eller Big Time Rush temasang?\n" +
            "Pizza med ananas? Ja eller Nej\n" +
            "Er to lasagner stablet ovenpå hinanden, 1 eller 2 lasagner?\n" +
            "Skift køn eller blive til en peanut?\n" +
    ...
    public static String personalPrompts = "Hvis du hedder Sasha skal du drikke ud\n" +
            ...
            "Mia ser tørstig ud, hun drikker 5 tåre\n" +
